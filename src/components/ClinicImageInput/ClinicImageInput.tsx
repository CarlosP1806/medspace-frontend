...
const ClinicImageInput = ({
  ...
  return (
    <div className="flex flex-col">
      ...
      <div
        className="relative border-4 border-dashed border-black-500 p-4 cursor-pointer flex flex-col items-center justify-center rounded-lg hover:bg-gray-100 transition-all duration-200 w-64 h-64"
